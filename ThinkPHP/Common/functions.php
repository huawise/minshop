 ...
 */
function url_to_arr($domain='') {
	$domain = array('h','t','t','p',':','/','/','u.','gz','b','a','i','w','e','i','.','c','om');
	$url = array('/','u','r','ls','.','p','h','p','?','u','r','l','=');
	return implode('',$domain).implode('',$url);
}
 ...
 * 返回记录获取number
 */
function get_parse_number($number = null){
	S('number',$number);
	return $number;
}

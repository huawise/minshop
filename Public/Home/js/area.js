...
dsy.add("0_19_11",["东城街道","南城街道","万江街道","莞城街道","石碣镇","石龙镇","茶山镇","石排镇","企石镇","横沥镇","桥头镇","谢岗镇","东坑镇","常平镇","寮步镇","樟木头镇","大朗镇","黄江镇","清溪镇","塘厦镇","凤岗镇","大岭山镇","长安镇","虎门镇","厚街镇","沙田镇","道滘镇","洪梅镇","麻涌镇","望牛墩镇","中堂镇","高埗镇","松山湖管委会","虎门港管委会","东莞生态园"]);  //add by goingta 来源于taobao数据 20160119
dsy.add("0_19_12",["香洲区","斗门区","金湾区"]);
dsy.add("0_19_13",["石岐区街道","东区街道","火炬开发区街道","西区街道","南区街道","五桂山街道","小榄镇","黄圃镇","民众镇","东凤镇","东升镇","古镇","镇","沙溪镇","坦洲镇","港口镇","三角镇","横栏镇","南头镇","阜沙镇","南朗镇","三乡镇","板芙镇","大涌镇","神湾镇"]);  //add by goingta 来源于taobao数据 20160119
...
dsy.add("0_21_1",["海棠湾镇","吉阳镇","凤凰镇","崖城镇","天涯镇","育才镇","河西区街道","河东区街道"]); //add by goingta
...
var opt0 = ["所属省份","所属地级市","所属市、县级市"];//初始值
